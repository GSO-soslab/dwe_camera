...
def declare_camera_parameters(node: Node):
    ...
    compression_downscale_descriptor = ParameterDescriptor(description='Downscale factor for the low-bandwidth compressed stream. Read-only after startup.', read_only=True)
    ...
    node.declare_parameter('compression.downscale', 2, compression_downscale_descriptor)
